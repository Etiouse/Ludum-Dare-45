...
public static class GameParameters
{
    ...
    // Player
    public static float playerAttackSpeedDefault = 1 / 3f; // The second number is the number of attack per seconds
    public static float playerAttackSpeedUpgrade1 = 1 / 4f; 
    ...
    public static int playerMaxHealthUpgrade2 = 50;
    ...
    public static RangeInt airShieldActivationRange = new RangeInt(5, 10);
    public static RangeInt airShieldActivationRangeDefault = new RangeInt(5, 10);
    public static RangeInt airShieldActivationRangeUpgrade = new RangeInt(3, 7);
    ...
    // Shooter enemy
    public static readonly float SHOOTER_LIFE = 40f;
    ...
    // Shooter Projectiles
    public static float shooterProjectileSpeed = 25;
    ...
    // Cone
    public static readonly float CONE_LIFE = 30f;
    ...
    // Shooter Projectiles
    public static float coneProjectileSpeed = 35;
    ...
    // Braum
    public static readonly float BRAUM_LIFE = 60f;
    ...
    // Healer
    public static readonly float HEALER_LIFE = 60f;
    ...
    // Middle Boss
    public static readonly float MIDDLE_BOSS_LIFE = 150f;
    public static readonly float MIDDLE_BOSS_MOVEMENT_TIME = 2f;
    public static readonly float MIDDLE_BOSS_TIME_BETWEEN_ATTACKS = 8f;
